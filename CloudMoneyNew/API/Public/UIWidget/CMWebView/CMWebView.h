...
- (void)webViewDidStartLoad:(CMWebView *)webView;
- (void)webViewDidFinishLoad:(CMWebView *)webView;
- (void)webView:(CMWebView *)webView didFailLoadWithError:(NSError *)error;
- (BOOL)webView:(CMWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType;

@end

///无缝切换UIWebView   会根据系统版本自动选择 使用WKWebView 还是  UIWebView
@interface CMWebView : UIView
///内部使用的webView
